...
public class NBodyBruteDemo {
    ...
    public static void main(String[] args) throws FileNotFoundException {
       ...
       if(args.length<2){
        ...
        if(!check){
          System.out.println("Err: unknown dataset");
          return;
        }

        File file = new File(dataFolder+"/"+args[1]);
        ...
        System.out.println(args[1] + ", " + N + ", " + String.valueOf(end - start));
